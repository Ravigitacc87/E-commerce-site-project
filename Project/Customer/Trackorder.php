...
<table style='background-color: rgb(224, 249, 249,0.321);width: 100%;height: 180px;margin-top: 12px;border-radius: 35px;'>
    ...
    <th style='color: rgb(0, 0, 0);text-decoration: underline;'>Rewards</th>
    ...
    <td style='color: rgb(0, 0, 0);'>ClearTrip Flat Rs. 650 off on Round Trip Flight booking<BR>
    <P>Coupon code - CTEFKEAHBEQUDG, claim before Dec 30, 2024</P></td>
    <td><a href='#'><i class='fa-sharp fa-solid fa-file-word fa-2xl'></i></a><br><br>
        <span> Your order Invoice </span><a href='#'>Click Here</a></td>
</tr>
</table>
